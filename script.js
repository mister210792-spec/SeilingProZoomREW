...
function updateZoomLevel() {
    const zoomLevel1 = document.getElementById('zoom-level');
    const zoomLevel2 = document.querySelector('.zoom-level-small');
    const percent = Math.round(scale * 100) + '%';
    
    if (zoomLevel1) zoomLevel1.textContent = percent;
    if (zoomLevel2) zoomLevel2.textContent = percent;
}

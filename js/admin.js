...
const Admin = {
    ...
    isAdmin: function() {
        ...
        const isAdminUser = this.ADMIN_EMAILS.includes(user.email);
    ...
    adminUpdateUserPlan: async function() {
        if (!this.isAdmin()) {
            alert('❌ Доступ запрещен');
            return;
        }

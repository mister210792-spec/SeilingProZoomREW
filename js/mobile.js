...
// Добавьте в конец файла mobile.js

function menuEditDimensions() {
    closeElementContextMenu();
    ...
    if (el) {
        if (typeof showElementDimensionsModal === 'function') {
            showElementDimensionsModal(el);
        } else {
...
// Экспортируем
window.menuEditDimensions = menuEditDimensions;
